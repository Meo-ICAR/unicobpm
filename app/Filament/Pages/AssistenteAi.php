...
/**
 * Assistente AI di sola consultazione: risponde a domande sull'uso dell'applicazione,
 * indicizzato da `php artisan manual:sync` (vedi ManualAssistantAgent). Non ha memoria tra
 * una domanda e l'altra e non può agire: per richieste estemporanee che richiedono
 * un'azione (es. sollecitare un Fornitore) vedi la Segretaria AI.
 *
